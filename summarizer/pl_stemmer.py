...
class PolishStemmer(object):
    ...
    def get_stem(self, word):
        stemmed_word = word
        for method in [self.__remove_adjective_ends,
                       self.__remove_adverbs_ends,
                       self.__remove_diminutive,
                       self.__remove_general_ends,
                       self.__remove_nouns,
                       self.__remove_plural_forms,
                       self.__remove_verbs_ends]:
            stemmed_word = method(stemmed_word)

        return stemmed_word

    def __remove_general_ends(self, word):
    ...
    def __remove_diminutive(self, word):
        if len(word) > 6:
    ...
    def __remove_verbs_ends(self, word):
    ...
    def __remove_adjective_ends(self, word):
    ...
    def __remove_adverbs_ends(self, word):
    ...
    def __remove_plural_forms(self, word):
    ...
    def __is_in_blacklist(self, word, blacklist):
